"""
Layer 5, Step 5.5 — dashboard Data Prep
Reshapes communication_results into a dashboard-optimised star schema.
...
Relationships for dashboard data model
...
PBI_DIR     = os.path.join(BASE_DIR, "outputs", "dashboard")
...
# T01 — outputs/dashboard/ directory exists
check("T01  outputs/dashboard/ directory exists", os.path.isdir(PBI_DIR))
...
print()
print("Step 5.5 complete — dashboard data prep files written to outputs/dashboard/.")
print("Ready for Step 5.6 (dashboard Dashboard build in dashboard Desktop).")
