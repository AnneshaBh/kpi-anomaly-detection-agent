...
Method C of the Layer 2 anomaly detection ensemble â€” Prophet Forecasting.
...
three exogenous regressors â€” making it the strongest method for catching
...
OUTPUT_CSV  = DATA / "detection/method_c_results.csv"
...
def fit_prophet(df: pd.DataFrame, kpi: str) -> pd.DataFrame:
    ...
    m = Prophet(
        ...
        yearly_seasonality=True,
        daily_seasonality=False,
        changepoint_prior_scale=0.05,   # default â€” moderate trend flexibility
...
def print_summary(results: pd.DataFrame, metrics: dict) -> None:
    ...
    print(f"  Scope         :  Tier 1 KPIs only  â€”  in-sample detection on all 731 days")
    print(f"  Flag rule     :  actual < yhat_lower  OR  actual > yhat_upper")
    print()

    # â”€â”€ Per-KPI section â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Overall evaluation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
