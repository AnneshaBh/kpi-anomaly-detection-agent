...
INPUT_CSV  = os.path.join(DATA_DIR, "intelligence", "priority_results.csv")
OUTPUT_CSV = os.path.join(DATA_DIR, "intelligence", "recommendations.csv")
...
for effort in ["H", "M", "L"]:
    ...
    _n_total = len(out)
    print(f"  {effort}  {n:>3}  ({n/_n_total*100:.1f}%)")
