...
INPUT_CSV  = os.path.join(DATA_DIR, "rca_assembly.csv")
OUTPUT_CSV = os.path.join(DATA_DIR, "impact_results.csv")
...
assert rca.shape == (181, 45), f"Expected (181, 45), got {rca.shape}"
...
assert impact.shape == (181, 51), f"Expected (181, 51), got {impact.shape}"
