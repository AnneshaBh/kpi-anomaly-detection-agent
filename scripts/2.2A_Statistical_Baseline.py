...
Method A of the Layer 2 anomaly detection ensemble — Statistical Baseline.
...
OUTPUT_CSV  = DATA / "method_a_results.csv"
...
def main() -> None:
    print()
    print("=" * 60)
    print("  Method A — Statistical Baseline")
    print("=" * 60)
