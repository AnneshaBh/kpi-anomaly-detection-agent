...
check("T05  executive_summary.md contains '181' (total anomaly count)", "181" in exec_content)

# T06 — executive_summary.md contains ESCALATE count "15"
check("T06  executive_summary.md contains '15' (ESCALATE count)", "| 15 |" in exec_content)
