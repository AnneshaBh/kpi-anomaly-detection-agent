...
Step 3 - ROOT CAUSE ANALYSIS
  ...
  LOW severity anomalies skip RCA — they are Tier 3 background signals.
...
1. {Highest-priority action from the top-ranked anomaly — specific and actionable}
2. {Second priority}
3. {Third priority}
...
class KPIAnomalyOrchestrator:
    ...
    def run(self, date: str) -> dict:
        ...
        while turns < self.MAX_TURNS:
            ...
            # Unexpected stop reason — log and exit loop
        ...
        log_path = DATA_DIR / "agent_run_log.json"
...
if __name__ == "__main__":
    ...
    df = pd.read_csv(DATA_DIR / "anomaly_results.csv")
